...
commandProperties={@HystrixProperty(name="execution.isolation.thread.timeoutInMilliseconds",value="100000")},
...
public class UserDao {
  ...
  /**
   * 调用鉴权服务
   * 这里要注意，当方法内部抛出exception时默认也会调用降级方法，此时需要配置ignoreException属性
   * @param token
   * @return
   */
